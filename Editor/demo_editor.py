...
class Options:
    ...
    def parse(self):
        ...
        parser.add_argument('--checkpoints_root',
                            type=str,
                            default='/home/slam/devdata/NSEPN/checkpoints/scannet/01*-scene0113__NoSGS__FIXBUG_020202113_edit',#/home/slam/devdata/pointnerf/checkpoints/scannet/scene000-T
