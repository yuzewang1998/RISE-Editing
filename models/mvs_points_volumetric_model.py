...
class MvsPointsVolumetricModel(NeuralPointsVolumetricModel):
    ...
    def grow_points(self, points_xyz, points_embedding, points_color, points_dirx,points_diry,points_dirz, points_conf,add_label):
        self.neural_points.grow_points(points_xyz, points_embedding, points_color, points_dirx,points_diry,points_dirz, points_conf,add_label)
